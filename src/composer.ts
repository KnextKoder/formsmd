import { placeholdersAndCallingCodes } from "./phone-numbers";
import { getDefaultSettings } from "./settings-parse";
 ...
 */
export function composeAttrs(params: Record<string, any>): string[] {
	const attrs: string[] = [];
...
export class Composer {
	...
	passedSettings: Record<string, any> = {};
	 ...
	 * @returns {string}
	 */
	slide = (params: Record<string, any> = {}) => {
		var instance = this;
	 ...
	 * @returns {string}
	 */
	startSlide = (params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	endSlide = (params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	p = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h1 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h2 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h3 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h4 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h5 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	h6 = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	ul = (items: string[], params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	ol = (items: string[], params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	blockquote = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	code = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	divStart = (params: Record<string, any> = {}) => {
		const instance = this;
	 ...
	 * @returns {string}
	 */
	div = (content: string, params: Record<string, any> = {}) => {
		const instance = this;
