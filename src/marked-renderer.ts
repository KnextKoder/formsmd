...
import {
	...
	createDatetimeField,
	createFileField,
} from "./form-field-create";
import { escape$1, cleanUrl } from "./helpers";
import { getTranslation } from "./translations";
import { marked } from "marked";

export interface MarkedSettings {
	"css-prefix": string;
 ...
 * the template.
 */
export function getMarkedSettings(options: any): MarkedSettings {
	let markedSettings: MarkedSettings = {
		"css-prefix": "fmd-",
		"form-delimiter": "|",
		"id": "",
		"localization": "en",
	...
	if (!options || options.markedSettings === undefined) {
...
export const renderer: any = new marked.Renderer();
