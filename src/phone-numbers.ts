export interface PhonePlaceholderAndCallingCode {
	placeholder: string;
	callingCode: string;
}

export const placeholdersAndCallingCodes: Record<
	string,
	PhonePlaceholderAndCallingCode
> = {
 ...
 *
/**
 * Given a country code, get the phone number placeholder.
 */
